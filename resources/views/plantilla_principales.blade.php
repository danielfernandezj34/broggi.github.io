        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" id="navbarColor01">
            <ul class="navbar-nav ml-auto mr-5">
                <li class="nav-item dropdown">
                    ...
                    <a id="user_id" class="nav-link dropdown-toggle text-white" data-id_user="{{ Auth::user()->id }}" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
