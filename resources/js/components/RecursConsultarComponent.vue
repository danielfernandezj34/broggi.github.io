    ...
    <main>
        <div class="card mt-3">
            <div class="card-body mt-1">
                <h5 class="card-title" id="titol_form">Taula d'Incidencies Asignades</h5>
                ...
                <table class="table-responsive-sm mt-2">
                    <thead>
                        <tr>
                            ...
                            <th v-if="usuari.id==1" scope="col">Administratiu</th>
                            <th v-else scope="col">Adreça</th>
                            <th scope="col"></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="usuari in usuaris" :key="usuari.id">
                            ...
                            <td>{{ usuari.email }}</td>
                            <td>
                                <button class="btn btn-secondary btn-sm"><i class="far fa-eye"></i> Veure Més</button>
